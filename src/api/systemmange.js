...
export function fetchUserMenuList() {
  return request.service({
    url: '/prod-api/v1/menu/list/side',
    method: 'post'
  })
}
...
export function getMenusRoleList(data) {
  return request.service({
    url: '/prod-api/v1/menu/list/drop',
    method: 'post',
    data
  })
}
...
export function getMessageUpdateStatus(data) {
  return request.service({
    url: '/prod-api/v1/message/update_status',
    method: 'post',
    data: data
  })
}
