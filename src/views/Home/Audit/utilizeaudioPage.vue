<template>
  <div class="description">
    <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>档案利用审核</el-breadcrumb-item>
              ...
              <el-col :span="24">
                <el-form :inline="true" :model="queryInfo" class="demo-form-inline" >
                  <el-form-item label="文件题名">
                    <el-input clearable v-model="queryInfo.wjtm" placeholder="请输入文件题名" @change="getUtilizeCheckRecordFileListFun"></el-input>
                  </el-form-item>
                  <el-form-item label="文件档号">
                    <el-input clearable v-model="queryInfo.wjdh" placeholder="请输入文件档号" @change="getUtilizeCheckRecordFileListFun"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-button type="primary" icon="el-icon-search" @click="getUtilizeCheckRecordFileListFun">查询</el-button>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
              ...
              <el-table-column
               ...
               fixed="right"
                ...
                <template slot-scope="scope">
                  ...
                  <el-button type="primary" size="small" @click.native="getRegisterCheckUtilizeFileUrlFileIdFun(scope.row)">文件预览</el-button>
...
import {
  getUtilizeCheckRecordFileList,
  getRegisterCheckUtilizeFileUrlFileId
} from '@/api/utilize'
...
export default {
  ...
  mounted () {
    ...
    this.getUtilizeCheckRecordFileListFun()
...
destroyed() {
  ...
  // type your function
   //获取文件预览域名
    ...
    //文件预览
    getRegisterCheckUtilizeFileUrlFileIdFun(row){
        const that = this
      const q ={
        file_id:row.file_id
      }
      ...
      getRegisterCheckUtilizeFileUrlFileId(q,apiUrl).then(response =>{
        ...
        type: 'warning'
         ...
         const q ={
          ...
          if (response.status === 200) {
            ...
            this.getUtilizeCheckRecordFileListFun() //刷新文件列表
            }
          })
      }).catch(() => {
        this.message({
  ...
  //打开新增文件弹层
    ...
    //获取文件列表
    getUtilizeCheckRecordFileListFun(){
      const q ={
      ...
      console.log(apiUrl)
      getUtilizeCheckRecordFileList(q,apiUrl).then(response =>{
       if (response.status === 200) {
        const { data: res, message, status } = response.data
        if (status !== 200) return this.message({ message: message, type: 'error' })
