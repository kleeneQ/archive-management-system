           ...
           <el-col :span="24">
             ...
             <el-form :inline="true" :model="queryInfo" class="demo-form-inline" label-width="110px">
               <el-form-item label="题名">
                 <el-input clearable v-model="queryInfo.wjtm" placeholder="请输入题名" @change="getAudioCollectionFileListFun"></el-input>
               </el-form-item>
            <el-form-item label="拍摄起始时间">
              <el-date-picker type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择拍摄起始时间" v-model="queryInfo.start_time" @change="getAudioCollectionFileListFun"></el-date-picker>
            </el-form-item>
             <el-form-item label="拍摄终止时间">
              <el-date-picker type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" placeholder="选择	拍摄终止时间" v-model="queryInfo.end_time" @change="getAudioCollectionFileListFun"></el-date-picker>
            </el-form-item>
            <el-form-item label="拍摄者">
              <el-input clearable v-model="queryInfo.psz" placeholder="请输入拍摄者" @change="getAudioCollectionFileListFun"></el-input>
            </el-form-item>
            <el-form-item label="拍摄地点">
              <el-input clearable v-model="queryInfo.psdd" placeholder="请输入拍摄地点" @change="getAudioCollectionFileListFun"></el-input>
            </el-form-item>
            <el-form-item label="人物">
              <el-input clearable v-model="queryInfo.rw" placeholder="请输入人物" @change="getAudioCollectionFileListFun"></el-input>
            </el-form-item>
            <el-form-item label="事件">
              <el-input clearable v-model="queryInfo.sj" placeholder="请输入事件" @change="getAudioCollectionFileListFun"></el-input>
            </el-form-item>
                  <el-form-item>
                    <el-button type="primary" icon="el-icon-search" @click="getAudioCollectionFileListFun">查询</el-button>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
              ...
              <div class="eltablebox" style="padding:0px">
               <el-col>
                ...
                <el-form :inline="true" :model="queryInfo" class="demo-form-inline">
                  <el-form-item>
                    <el-button type="primary" icon="el-icon-upload2" @click="downloadFileAudioFun()">批量导出附件</el-button>
                  </el-form-item>
                   <el-form-item>
                    <el-button type="primary" icon="el-icon-upload2" @click="exportAudioCollectionFileFun('批量导入文件')">批量导出附件信息</el-button>
                  </el-form-item>
                </el-form>
              </el-col> 
            <!-- 案卷文件列表 -->
              ...
              <el-table-column
               ...
               fixed="right"
                ...
                <template slot-scope="scope">
                  ...
                  <el-button type="primary" size="small" @click.native="getAudioCollectionFileUrlFileIdFun(scope.row)">文件预览</el-button>
                </template>
              </el-table-column>
            </el-table>
            <el-pagination
...
<script>
import {
  // getAudioCollectionFileList,
  importAudioPictureFile,
  addAudioPictureFile,
  updateAudioPictureFile,
  // getAudioCollectionFileUrlFileId,
  removeFileAudio,


  downloadAudioModel,
  downloadFileAudio,
  exportAudioCollectionFile,
  getAudioCollectionFileList,
  getAudioCollectionFileUrlFileId,
...
export default {
  ...
  mounted () {
    ...
    this.getAudioCollectionFileListFun()
  ...
  // 导出馆藏档案文件信息
  exportAudioCollectionFileFun(){
    console.log(this.file_ids.length)
    if (this.file_ids.length == 0) return this.message({ message: '请勾选需要导出的文件', type: 'warning' })
    const q = {
      file_ids:this.file_ids.join('#')
    }
    exportAudioCollectionFile(q).then(response => {
        let headersName = ''
        if (response.headers['content-disposition']) {
          headersName = response.headers['content-disposition'].split('=')[1]
        }
  ...
  detailsVisibleFun(row){
   ...
   //获取文件预览域名
    ...
    //文件预览
    getAudioCollectionFileUrlFileIdFun(row){
        const that = this
      const q ={
        file_id:row.file_id
      }   
      getAudioCollectionFileUrlFileId(q).then(response =>{
