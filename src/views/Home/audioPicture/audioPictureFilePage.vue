              ...
              <el-col :span="24">
                ...
                <el-form :inline="true" :model="queryInfo" class="demo-form-inline" >
                  <el-form-item label="文件题名">
                    <el-input clearable v-model="queryInfo.wjtm" placeholder="请输入文件题名" @change="getAudioPictureFileListFun"></el-input>
                  </el-form-item>
                  <el-form-item label="文件档号">
                    <el-input clearable v-model="queryInfo.wjdh" placeholder="请输入文件档号" @change="getAudioPictureFileListFun"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-button type="primary" icon="el-icon-search" @click="getAudioPictureFileListFun">查询</el-button>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
              ...
              <el-table-column
               ...
               fixed="right"
                ...
                <template slot-scope="scope">
                  ...
                  <el-button type="primary" size="small" @click.native="getAudioPictureFileUrlFileIdFun(scope.row)">文件预览</el-button>
   ...
   <!-- 选择导入文件的弹层 （表格） -->
    ...
    >
      <el-form
        ...
        label-width="100px"
      >
        <el-form-item label="导入文件：" prop="bm" style="margin-bottom:50px;">
          <el-upload
            class="upload-demo"
            ref="upload"
            action="#"
...
<script>
import {
  getAudioPictureFileList,
  importAudioPictureFile,
  addAudioPictureFile,
  updateAudioPictureFile,
  getAudioPictureFileUrlFileId,
...
export default {
  ...
  mounted () {
    ...
    this.getAudioPictureFileListFun()
...
destroyed() {
  ...
  // type your function
   //获取文件预览域名
    ...
    //文件预览
    getAudioPictureFileUrlFileIdFun(row){
        const that = this
      const q ={
        file_id:row.file_id
      }
      ...
      getAudioPictureFileUrlFileId(q,apiUrl).then(response =>{
  ...
  //打开新增文件弹层
    ...
    getAudioPictureFileListFun(){
      ...
      console.log(apiUrl)
      getAudioPictureFileList(q,apiUrl).then(response =>{
       if (response.status === 200) {
        const { data: res, message, status } = response.data
        if (status !== 200) return this.message({ message: message, type: 'error' })
