        ...
        <el-col>
          <el-form :inline="true" :model="queryInfo" class="demo-form-inline" label-width="100px">
            <el-form-item label="标题">
              <el-input clearable v-model="queryInfo.file_title" placeholder="请输入标题"  @change="getOfficeFilePlaceListFun"></el-input>
            </el-form-item>
            <el-form-item label="来文时间">
              <el-date-picker
                ...
                @change="getOfficeFilePlaceListFun"
                placeholder="请选择来文时间">
              </el-date-picker> —
              <el-date-picker
            ...
            <el-form-item>
              <el-button type="primary" icon="el-icon-search" @click="getOfficeFilePlaceListFun">查询</el-button>
            </el-form-item>
          </el-form>
        </el-col>
      </el-row>
...
export default {
  ...
  mounted () {
    this.getOfficeFilePlaceListFun() //已归档列表
    
  },
  methods: {
  // type your function
  //已归档列表
    getOfficeFilePlaceListFun(){
        this.queryInfo.page_num=this.currentPage,
        this.queryInfo.page_size=this.pageSize,
      getOfficeFilePlaceList(this.queryInfo).then(response =>{
       if (response.status === 200) {
        ...
        if (status !== 200) return this.message({ message: message, type: 'error' })
         ...
         if (res.total !== 0 && res.list.length == 0 ) {
           this.currentPage = 1
           this.getOfficeFilePlaceListFun()
         }
         this.OfficeFilePlaceList = res.list
